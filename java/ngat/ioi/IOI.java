...
public class IOI
{
	...
	public void shutdownController() throws Exception
	{
		...
		{
			throw new Exception(this.getClass().getName()+":shutdownController:PowerDownASIC failed:"+
	...
	/**
	 * Get the telnet connection instance for connecting to the IDL server.
	 * @return The TelnetConnection instance.
	 * @see #idlTelnetConnection
	 */
	public TelnetConnection getIDLTelnetConnection()
	{
