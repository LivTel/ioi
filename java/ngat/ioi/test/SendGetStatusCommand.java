...
{
	/**
	 * The default port number to send ISS commands to IO:I.
	 */
	static final int DEFAULT_IOI_PORT_NUMBER = 7373;
	/**
	 * The default port number for the ISS server, to receive ISS commands from IO:I.
	 */
	static final int DEFAULT_SERVER_PORT_NUMBER = 7383;
	/**
	 * The ip address of the IO:I robotic software machine, to send ISS commands to the IO:I robotic software.
	 */
	private InetAddress address = null;
	/**
	 * The port number of the IO:I robotic software.
	 */
	private int ioiPortNumber = DEFAULT_IOI_PORT_NUMBER;
	/**
	 * The port number for the ISS server, to recieve ISS commands from IO;I.
	 */
	private int serverPortNumber = DEFAULT_SERVER_PORT_NUMBER;
	/**
	 * The ISS server class that listens for connections from IO:I.
	 */
	...
	private void help()
	{
		...
		System.out.println("\t-p[ort] <port number> - Robotic software port of IO:I to send ISS commands to.");
		System.out.println("\t-[ip]|[address] <address> - Address of machine running IO:I robotic software to send ISS commands to.");
		System.out.println("\t-l[evel] <number> - Specify GET_STATUS level.");
		System.out.println("\t-s[erverport] <port number> - Port for the fake ISS server used by IO:I to send commands back.");
		System.out.println("The default server port is "+DEFAULT_SERVER_PORT_NUMBER+".");
		System.out.println("The default IO:I robotic software port is "+DEFAULT_IOI_PORT_NUMBER+".");
	}
